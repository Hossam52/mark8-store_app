...
class PrepareOrdersDeliveryTab extends StatelessWidget {
  const PrepareOrdersDeliveryTab({Key? key}) : super(key: key);
  @override
    ...
    return Builder(builder: (context) {
      return Column(
        ...
        children: [
          ...
          OrdersViewList(items: List.generate(4, (index) => 1)),
          Divider()
        ],
      );
    });
  ...
  Column _shopperIdentityColumn() {
    return Column(
      ...
      children: [
        ...
        _ShopperIdentity(name: 'Hossam Hassan', id: 355),
        Divider(),
      ],
    );
  }
  ...
  Column _buyerIdentityColumn() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Driver identity', style: getRegularStyle()),
        _ShopperIdentity(name: 'Ahmed Hossam', id: 221456),
        SizedBox(height: 8),
        Divider()
      ],
    );
